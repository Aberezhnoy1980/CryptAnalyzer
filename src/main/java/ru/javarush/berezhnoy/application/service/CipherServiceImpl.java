...
import ru.javarush.berezhnoy.domain.model.AlphabetFactory;
...
public class CipherServiceImpl implements CipherService {
    ...
    public CipherServiceImpl() {
        EnhancedAlphabet alphabet = AlphabetFactory.createFromConfig();
        this.cipher = new CaesarCipher(alphabet);
        logger.info("CipherService initialized with {} alphabet",
                cipher.getAlphabet().getSize());
    }
    ...
    public void encrypt(String inputPath, String outputPath, int key)
        ...
        try {
            ...
            logger.info("Encryption completed: {} -> {} (key: {})",
    ...
    public void decrypt(String inputPath, String outputPath, int key)
        ...
        try {
            ...
            logger.info("Decryption completed: {} -> {} (key: {})",
                    inputPath, outputPath, key);
        } catch (Exception e) {
    ...
    public void statisticalAnalysis(String inputPath, String outputPath,
                                    String referenceTextPath) throws CaesarCipherException {
        try {
